...
reader.close()
path = os.path.join(r'/Users/yasukoisoe/fishfishfish/', 'deepposekit_locomotion/predictions.npy' )
predictions = np.load(path)

# print("predictions: %s" % np.shape(predictions))
...
data_generator = DataGenerator(r'/Users/yasukoisoe/fishfishfish/deepposekit_locomotion/annotation_data_release_merged.h5')
...
writer = cv2.VideoWriter(r'/Users/yasukoisoe/fishfishfish/deepposekit_locomotion/medaka_posture.avi', fourcc, 30.0,  (192 * 2, 192 * 2))

# writer = VideoWriter(r'/Users/yasukoisoe/fishfishfish/deepposekit_locomotion/medaka_posture.mp4', (192 * 2, 192 * 2), 'MP4V', 30.0)
reader = VideoReader(r'/Users/yasukoisoe/fishfishfish/deepposekit_locomotion/fish_roi_resized.avi', batch_size=1)
